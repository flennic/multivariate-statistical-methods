...
bon_interval1 <- c(0,0)
bon_interval1[1] <- x_bar[1] - qt(0.95/(2*p), n-1)*sqrt(S[1,1]/n)
bon_interval1[2] <- x_bar[1] + qt(0.95/(2*p), n-1)*sqrt(S[1,1]/n)

bon_interval2 <- c(0,0)
bon_interval2[1] <- x_bar[2] - qt(0.95/(2*p), n-1)*sqrt(S[2,2]/n)
bon_interval2[2] <- x_bar[2] + qt(0.95/(2*p), n-1)*sqrt(S[2,2]/n)
...
ggplot(bird_data) + 
  geom_line(aes(x = Tail_length, y = Wing_length))
